...
![Figure1 Font Size in HoloLens](./Font_size_HoloLens.png)
...
![Figure2 Optimal distance for placing holograms from the user](./Hololens_distance.png)

Figure2 Optimal distance for placing holograms from the user

![Figure3 Text size demo](./Text_size.gif)
...
![Figure4 Text Size Survey](./TextSize_Survey.png)
