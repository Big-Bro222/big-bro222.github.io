...
<left>
    ...
    src="./Font_size_HoloLens.png" width = "60%" alt="Font_size_HoloLens.png"/>
    <br>
...
<left>
    <img style="border-radius: 0.1125em;
    box-shadow: 0 2px 1px 0 rgba(34,36,38,.12),0 2px 5px 0 rgba(34,36,38,.08);" 
    src="./Hololens_distance.png" width = "60%" alt="Hololens_distance.png"/>
    <br>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;">
...
<left>
    ...
    box-shadow: 0 2px 1px 0 rgba(34,36,38,.12),0 2px 5px 0 rgba(34,36,38,.08);" 
    src="https://qi-uxportfolio.firebaseapp.com/static/media/text%20size.46e767b1.gif" width = "60%" alt="text_size.gif"/>
    <br>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;">
...
<left>
    <img style="border-radius: 0.1125em;
    box-shadow: 0 2px 1px 0 rgba(34,36,38,.12),0 2px 5px 0 rgba(34,36,38,.08);" 
    src="./TextSize_Survey.png" width = "60%" alt="TextSize_Survey.png"/>
    <br>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;">
